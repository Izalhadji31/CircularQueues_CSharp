...
namespace CircularQueues_CSharp
{
    class Queues
    {
        ...
        public void insert(int element)
        {
            ...
            /* The folloeing statement cheks whether the queue is empty. If the queue is
            ...
            else
            {
                ...
                if (REAR == max - 1)
                    ...
                    /* If REAR is not at the last poition, then its value is
                     * incremented by one. */
                    REAR = REAR + 1;
            }
        ...
        public void remove()
        {
            ...
            else
            {
                ...
                if (FRONT == max - 1)
                    ...
                    /* FRONT is incremented by on if it is not the first element of array. */
                    FRONT = FRONT+ 1;
            }
        }
        public void display()
